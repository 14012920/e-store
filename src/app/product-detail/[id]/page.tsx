    ...
    <AppContainer>
      <div className="flex flex-col px-4 pb-4 lg:px-24 pt-16 lg:pt-4 overflow-y-auto min-h-full">
        {Object.keys(product).length > 0 ? (
                ...
                <div className="flex flex-1 item-center w-full  flex-col lg:mx-8">
                  <div className="p-2 flex flex-col">
                    <div>
                      ...
                      <Rating
                        initialValue={avargeRating < 3 ? 4 : avargeRating}
                        readonly
                        size={20}
                      />
                    </div>
                  ...
                  <div className="mx-4 mt-3">
                    ...
                    <p className="text-sm font-light from-neutral-300 pb-1">
                      {product?.description}
                    </p>
                  </div>
                </div>
          ...
          <div className="flex flex-1 flex-col items-center min-h-full">
